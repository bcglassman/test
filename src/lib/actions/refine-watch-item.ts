...
export async function refineWatchItem(
  ...
  const response = await client.messages.create({
    ...
    system: [
      ...
      "",
      "Rewrite the observation in the precise, plain terminology a canine ",
      "rehab practitioner would use: correct anatomy (stifle, hock, ",
      "carpus, thoracic/pelvic limb) and movement language (abduction, ",
      "weight-shift, cadence, loading).",
      "",
